...
export async function GET(
  ...
  if (!phone || !phone.affiliateLinks.flipkart) {
  ...
  try {
    ...
    console.error('Error logging Flipkart affiliate click', err);
  }

  // Redirect
  return NextResponse.redirect(phone.affiliateLinks.flipkart);
}
