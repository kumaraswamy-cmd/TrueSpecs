...
export default function BrandLogo({
  ...
  const renderSvg = () => {
    switch (normalized) {
      ...
      case 'vivo':
        return (
          <svg viewBox="0 0 100 100" className="w-full h-full block">
            ...
            <path d="M41 44 H45 V60 H41 Z" fill="#FFFFFF" />
            <path
      ...
      // 9. APPLE (Clean circle with exact Apple logo silhouette matching reference image)
      case 'apple':
        return (
          <svg viewBox="0 0 100 100" className="w-full h-full block">
            <circle cx="50" cy="50" r="49" fill="#FFFFFF" stroke="#E2E8F0" strokeWidth="2" />
            <g transform="translate(24, 18) scale(0.31)">
              <path
  ...
  return (
    <div
      className={`inline-flex items-center justify-center shrink-0 select-none overflow-hidden rounded-full aspect-square ${currentSize} ${className}`}
      title={brand}
    >
      {renderSvg()}
    </div>
